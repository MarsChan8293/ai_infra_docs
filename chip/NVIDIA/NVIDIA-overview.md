# 厂商与芯片：NVIDIA / 英伟达数据中心 GPU——Blackwell 与 Rubin

## 芯片页关系导航

本页是本目录唯一的厂家总览。下面的页面均按单一芯片、芯片家族或芯片关联产品对象拆分；芯片页中的“厂商总览”链接回到本页。`[[...]]` 用于 Obsidian 图谱，Markdown 链接用于普通阅读。

- [[rubin-cpx|NVIDIA / 英伟达 — Rubin CPX]] · [打开 Markdown](./rubin-cpx.md)
- [[rubin-gpu|NVIDIA / 英伟达 — Rubin GPU]] · [打开 Markdown](./rubin-gpu.md)
- [[blackwell|NVIDIA / 英伟达 — Blackwell B100、B200 与 GB200]] · [打开 Markdown](./blackwell.md)
...
>
> Blackwell 增量页研究截止日期与本次访问/核验日期均为 2026-09-05；页面覆盖 B100、B200、GB200 的 GPU、Superchip、服务器/机架和云服务边界，见 [Blackwell 证据页](./blackwell.md)。
...
| 对象 | 窗口内状态 | 芯片与系统边界 |
|---|---|---|
| **Blackwell / B200 / GB200** | 2024-03-18 发布 Blackwell 与 GB200/B200 平台；NVIDIA 当前架构页标注 Blackwell 已进入 full production；B200/HGX/DGX 和 GB200 NVL72 已有官方产品与系统资料。单 GPU 批次、具体云 SKU 和区域库存按型号公开资料未完全确认。来源：[架构页](https://www.nvidia.com/en-us/data-center/technologies/blackwell-architecture/)；[发布公告](https://nvidianews.nvidia.com/news/nvidia-blackwell-platform-arrives-to-power-a-new-era-of-computing)；[GB200 NVL72](https://www.nvidia.com/en-us/data-center/gb200-nvl72/)（核验：2026-09-05）。 | B200 是 180GB HBM3e 单 GPU；GB200 是 2×B200 + Grace CPU 的 Superchip；NVL72 是 72 GPU + 36 Grace CPU 的液冷机架，三层规格分开记录。 |
