...
evidence:
  S1:
    url: https://www.iluvatar.com/productDetails?fullCode=cpjs-yj-ytxl-TY1100_NX
    source_type: other
    accessed: '2026-09-16'
evidence_map:
  __page__:
...
> 边端算力终端，包含 CPU 与系统内存，不是裸 GPU。

## 核心规格
- 32/64GB LPDDR5x + 16GB LPDDR5x；12-Core Arm。
- 130×130×63mm。

## 直接来源
- https://www.iluvatar.com/productDetails?fullCode=cpjs-yj-ytxl-TY1100_NX
