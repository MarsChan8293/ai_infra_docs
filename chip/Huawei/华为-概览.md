# 厂商与芯片：华为昇腾 Ascend 950 系列与 910B 主流代际

## 芯片页关系导航

本页是本目录唯一的厂家总览。下面的页面均按单一芯片、芯片家族或芯片关联产品对象拆分；芯片页中的“厂商总览”链接回到本页。`[[...]]` 用于 Obsidian 图谱，Markdown 链接用于普通阅读。

- [[ascend-950dt|Huawei / 华为昇腾 — Ascend 950DT]] · [打开 Markdown](./ascend-950dt.md)
- [[ascend-950pr|Huawei / 华为昇腾 — Ascend 950PR]] · [打开 Markdown](./ascend-950pr.md)
- [[ascend-910b|Huawei / 华为昇腾 — Ascend 910B]] · [打开 Markdown](./ascend-910b.md)

> 研究范围：华为昇腾，资料窗口为 2025-07-01 至 2026-09-05。950 系列原始资料访问日期为 2026-08-22；910B 增量页访问/核验日期为 2026-09-05。对照基线为附件《推导推理GPU新路径-ELI5.html》（当前目录未提供）。
...
|---|---|---|
| Ascend 910B | 华为官方材料持续将 910B/910C 作为 950 前代基线；华为云 ModelArts API 和 CANN 软件仓库有 910B 资源/软件支持证据；芯片流片、量产、出货批次和普遍云库存公开资料未确认 | 910B 是芯片；`ASCEND_SNT9B` 是云资源类型；社区出现 64G 环境，但不回填为芯片级 HBM 容量 |
