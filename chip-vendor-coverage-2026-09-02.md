...
| 厂家目录 | 芯片拆分索引 |
| -- | -- |
| AMD | [AMD 芯片索引](./AMD/AMD-chip-index.md) |
| AWS | [AWS 芯片索引](./AWS/AWS-chip-index.md) |
| Biren | [壁仞科技 芯片索引](./Biren/壁仞科技-芯片索引.md) |
| Cambricon | [寒武纪 芯片索引](./Cambricon/寒武纪-芯片索引.md) |
| Cerebras | [Cerebras 芯片索引](./Cerebras/Cerebras-chip-index.md) |
| d-Matrix | [d-Matrix 芯片索引](./d-Matrix/d-Matrix-chip-index.md) |
| Enflame | [燧原科技 芯片索引](./Enflame/燧原科技-芯片索引.md) |
| FuriosaAI | [FuriosaAI 芯片索引](./FuriosaAI/FuriosaAI-chip-index.md) |
| Google | [Google 芯片索引](./Google/Google-chip-index.md) |
| Groq | [Groq 芯片索引](./Groq/Groq-chip-index.md) |
| Huawei | [华为 芯片索引](./Huawei/华为-芯片索引.md) |
| Hygon | [海光信息 芯片索引](./Hygon/海光信息-芯片索引.md) |
| Iluvatar | [天数智芯 芯片索引](./Iluvatar/天数智芯-芯片索引.md) |
| Kunlunxin | [昆仑芯 芯片索引](./Kunlunxin/昆仑芯-芯片索引.md) |
| MetaX | [沐曦 芯片索引](./MetaX/沐曦-芯片索引.md) |
| MooreThreads | [摩尔线程 芯片索引](./MooreThreads/摩尔线程-芯片索引.md) |
| NVIDIA | [NVIDIA 芯片索引](./NVIDIA/NVIDIA-chip-index.md) |
| Sunrise | [曦望 芯片索引](./Sunrise/曦望-芯片索引.md) |
| Tenstorrent | [Tenstorrent 芯片索引](./Tenstorrent/Tenstorrent-chip-index.md) |
| Xiaomi | [小米 芯片索引](./Xiaomi/小米-芯片索引.md) |
| openai | [openai 芯片索引](./openai/openai-chip-index.md) |

拆分页以各厂家综合报告为事实来源，保留芯片与板卡、模组、服务器、机架、云服务的层级边界。
- 研究截止日：2026-09-02；本次结构修订和覆盖核对：2026-09-05
...
| d-Matrix | Corsair/Pavehawk | DIMC、SRAM-first、3D DRAM 路线 | 低延迟推理 | Corsair full production；Pavehawk 实验室硅 | 2GB 性能内存与容量内存分层 | DMX/平台级，JetStream 单列 | 平台口径 | Aviator/软件栈待复核 | [报告](./d-Matrix/corsair.md) | 新增恢复 |
| Enflame | L600 | GCU | 训练/推理 | S60量产上市；L600量产交付未充分确认 | 见报告 | GCU/POD分开 | 卡/模组口径 | TopsRider | [报告](./Enflame/enflame-chips-2026-09-01.md) | 已完成 |
| FuriosaAI | RNGD Gen 2 | Tensor Contraction Processor | 推理 | 旧资料记录量产并部署；当前 GA 待复核 | 48GB HBM3；256MB SRAM（旧资料口径） | PCIe/多卡，待复核 | 150W/180W口径并列 | 编译器/TCL | [报告](./FuriosaAI/rngd-gen2.md) | 新增恢复 |
...
| Tenstorrent | Blackhole p150/Galaxy | RISC-V、Tensix、显式 Dataflow、NoC | 训练/推理 | Blackhole 首发；Galaxy 系统 GA/部署叙事 | 180MB 分布式 SRAM；32GB GDDR6 | 4×800G；Galaxy 系统级互联 | Galaxy 系统口径 | TT-Metalium/TTNN/TT-Forge | [报告](./Tenstorrent/blackhole.md) | 新增恢复 |
...
- 实际识别并纳入汇总的资料目录：21 个；其中 18 个为原有厂商目录，3 个为本次从历史架构资料恢复的独立路线目录；每个目录均有至少一份详细报告或资料不足说明。
