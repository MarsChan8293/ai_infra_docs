...
<div class="shell">
  ...
  <div class="grid">
    <aside class="panel">
      <div class="section"><h3>焦点节点</h3><input id="focusInput" type="text" list="nodeList" placeholder="输入 H100 / KV Cache / 拓扑感知 / GLM-5.3…"/><datalist id="nodeList"></datalist><div class="row" style="margin-top:7px"><button id="focusBtn" class="primary">聚焦</button><button id="openBtn">打开页面</button></div></div>
